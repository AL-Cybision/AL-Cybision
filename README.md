...
|--------|------|---------|---------|------------|
| [**CVE-2026-6691**](https://www.cve.org/cverecord?id=CVE-2026-6691) | 🔴 **8.6 High** | 🍃 [**MongoDB C Driver**](https://github.com/mongodb/mongo-c-driver) | Cyrus SASL username canonicalization heap buffer overflow via unsafe string copy | [CDRIVER-6134](https://jira.mongodb.org/browse/CDRIVER-6134) |
| [**CVE-2025-11157**](https://nvd.nist.gov/vuln/detail/CVE-2025-11157) | 🔴 **7.8 High** | 🍽️ [**Feast**](https://github.com/feast-dev/feast) | Unsafe PyYAML deserialization in Kubernetes materializer enables arbitrary code execution | [Fix PR #5643](https://github.com/feast-dev/feast/pull/5643) |
