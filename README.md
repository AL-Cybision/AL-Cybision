...
| [**CVE-2025-11157**](https://nvd.nist.gov/vuln/detail/CVE-2025-11157) | **7.8 High** | [**Feast**](https://github.com/feast-dev/feast) | Unsafe PyYAML deserialization in Kubernetes materializer enables arbitrary code execution | [Fix PR #5643](https://github.com/feast-dev/feast/pull/5643) |
