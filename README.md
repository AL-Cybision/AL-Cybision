...
|---------|-----------|-------|----------|----------|--------------|
| **CVE-2026-6691** | [CDRIVER-6134](https://jira.mongodb.org/browse/CDRIVER-6134) | ![CVSS 8.6](https://img.shields.io/badge/8.6-High-orange?style=flat-square) | [![MongoDB C Driver](https://img.shields.io/badge/MongoDB%20C%20Driver-green?logo=mongodb&style=flat-square)](https://github.com/mongodb/mongo-c-driver) | Cyrus SASL username canonicalization heap buffer overflow via unsafe string copy | [cve.org/CVERecord?id=CVE-2026-6691](https://www.cve.org/cverecord?id=CVE-2026-6691) |
